...
# [PUG-3] spawn seam: a placement must carry exactly one UnitData source,
# either "unit_data_path":String or already-built "unit_data":UnitData
# (generated forces, editor-baked units, reinforcements). The resolved unit is
