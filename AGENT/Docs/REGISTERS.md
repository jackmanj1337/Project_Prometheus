...
| `REQ-1..14` | Shared Requirement / Predicate System (Foundation F16) — Player-Facing Design + Open Questions | RESOLVED | 2026-06-25r (REQ-1..8) / 2026-06-26 (REQ-9 compare, REQ-10 chance, REQ-11 item-property, REQ-12 unit/pool/availability sources, REQ-13 spatial/state/relationship/aggregate families, REQ-14 condition potency/duration); author-extension registry rides F4, condition-potency a forward-req on F5 | `registers/requirement_predicate_system_open_questions_2026-06-25.md` |
