...
| `EXT-1..6` | Authoring Extensibility — What "Author-Extensible" Means Across the Vocabularies — Open Questions | OPEN | 2026-06-26 (EXT-1 model = A "A-plus" / EXT-2 content-fit / EXT-3 validation / EXT-4 determinism + EXT-5 *mechanism* — ratified off the `[REQ-16]` worked example); **still OPEN:** EXT-5 *cadence/process* + EXT-6 per-vocabulary confirmation (DLG effects · F4 profiles · MET) | `registers/authoring_extensibility_open_questions_2026-06-26.md` |
