...
| `REQ-1..10` | Shared Requirement / Predicate System (Foundation F16) — Player-Facing Design + Open Questions | RESOLVED | 2026-06-25r (REQ-1..8) / 2026-06-26 (REQ-9 value-term compare, REQ-10 chance gate); author-extension registry detail rides F4 / the define-all sweep | `registers/requirement_predicate_system_open_questions_2026-06-25.md` |
