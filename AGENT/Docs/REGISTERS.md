...
| `RDR-1..11` | `redirect` — Combat Effect-Redirect Primitive — Open Questions | RESOLVED | 2026-06-26 — full design-walk (session 2026-06-26f); RDR-1..11 settled. Remaining items are forward-reqs on other owners (F5/M8 effect event, A5 death-ordering, `[STY-9]` selector) + a spawned sibling primitive `cover` (`[CVR]`), not open design forks on `redirect` itself. | `registers/redirect_effect_open_questions_2026-06-26.md` |
