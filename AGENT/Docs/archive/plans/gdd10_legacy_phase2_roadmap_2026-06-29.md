...
> [`GDD_10_Roadmap.md`](../../../GDD/GDD_10_Roadmap.md) and
> [`project_control_plane_2026-06-29.md`](../../plans/project_control_plane_2026-06-29.md)
> during the 2026-06-29 Project Control Plane rewrite. Kept as legacy Phase 2
> roadmap source detail; active work rows now live in the Project Control Plane.

# GDD_10 — Phase 2 Implementation Roadmap

**Status:** Historical - legacy Phase 2 milestone tracker.
...
**MVP profile set** = `territorial`(latch) + `guard_tile` + `tethered`(re-evaluate, was `patrol`) + `flee` +
