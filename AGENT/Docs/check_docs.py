...
_FREE_TEXT_FIELD_ALLOWLIST = {
    ("scenes/ui/PrepScreen.tscn", "SlotId"):
        "save slot id; TEXT-12 ratified that ids become generated, so this field "
        "is expected to disappear rather than grow",
    ("scenes/ui/PrepScreen.tscn", "SaveLabel"):
        "save label -- the naming exception TEXT-06 explicitly allows",
}
