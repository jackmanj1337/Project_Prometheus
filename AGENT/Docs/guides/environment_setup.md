...
- `export_presets.cfg` — Windows preset used for playtest builds.
  Currently at `v0.4.2`; it excludes `AGENT/**`, `scripts/tests/**`, and
...
godot --headless --path . \
    --export-debug "Project Prometheus v0.4.2" \
    builds/Project_Prometheus_v0.4.2_debug.exe

# Release build
godot --headless --path . \
    --export-release "Project Prometheus v0.4.2" \
    builds/Project_Prometheus_v0.4.2.exe
```
