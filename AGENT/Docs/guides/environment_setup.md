...
- `export_presets.cfg` — Windows preset used for playtest builds.
  Currently at `v0.5.3`; it excludes `AGENT/**`, `scripts/tests/**`, and
...
godot --headless --path . \
    --export-debug "Project Prometheus v0.5.3" \
    builds/Project_Prometheus_v0.5.3_debug.exe

# Release build
godot --headless --path . \
    --export-release "Project Prometheus v0.5.3" \
    builds/Project_Prometheus_v0.5.3.exe
```
