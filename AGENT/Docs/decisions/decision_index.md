...
| RNG-2 | RNG state in snapshot contract | Applied | RNG→GDD_01 | Blocks reload-scumming. Retry, suspend, and rewind ledger snapshots carry and restore the RNG timeline; unified mid-map slots persist the ledger (B1-PKGA and B1-LEDGER, Implemented 2026-07-15). In GDD_01 §Determinism (3.1). |
