...
| RULE-009 | Light/Dark magic design scope | Ratified | Planned | REG | Design pass **decided 2026-07-20** (`decisions/decision_record_2026-07-20_light_dark_magic.md`): author Light + Dark tome families and wire the three-way magic triangle. Still precedes bulk class migration. Owns OPEN-10. |
...
| OPEN-10 | Cleric "Light E" | Ratified | Planned | JUN | **Resolved 2026-07-20**: Cleric is staff-only; Light arrives on promotion to Bishop. The `light` track is removed from the base class rather than left trainable with no tomes. |
