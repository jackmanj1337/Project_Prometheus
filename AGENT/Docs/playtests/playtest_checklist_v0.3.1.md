...
- [ ] Stick target cycling passes for attack and Pair Up.
...
Notes (which mode you picked, and why):
...
- [ ] Suspend/Continue still works (or note any regression).
...
- [ ] Suspend/Continue shows no regression (§6).
