...
# v0.8.2 Windows Tester Checklist

v0.8.1 was rejected before native testing. This replacement keeps its feature
scope but fixes the two findings that caused the rejection. Return this completed
...
- [ ] `BUILD_INFO.json`, `SHA256SUMS.txt`, the executable BUILD STAMP and Main
  Menu all say v0.8.2 and agree on the source commit.
...
- [ ] Diagnostics identify v0.8.2, Windows, GPU/display/DPI, window mode,
