...
# Playtester Handbook and Checklist - v0.3.3 (Focused Rerun)
...
- [ ] LT and RT feel equally controllable despite the unequal visual zoom ratios.
- [ ] Action Menu remains anchored correctly after zooming.
...
- [ ] Near list ends, scrolling clamps cleanly without blank overflow.
- [ ] At 2.0x, the margin shrinks when necessary instead of clipping controls.
- [ ] No horizontal scrollbar appears.
- [ ] Every row, paired-unit entry, and Back remains reachable.
...
- [ ] `dual_outline` is active by default; F8 no longer changes its mode.
- [ ] Action Menu retains threat/watch plus the selected unit's movement range.
- [ ] Action Menu clears path arrows and hover-peek paint.
- [ ] Map Menu retains threat/watch but not a movement range.
- [ ] Map Menu clears path arrows and hover-peek paint.
- [ ] Closing either menu restores normal interactive overlays without residue.
- [ ] Enemy phase and suspend/continue do not retain stale threat positions.
