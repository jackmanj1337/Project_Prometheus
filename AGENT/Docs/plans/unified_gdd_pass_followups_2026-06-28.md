...
| Pre-GDD triage reprioritization 2026-06-28 | The planned/unimplemented feature list is now dependency-banded into v1-core Bands 1-5, v1-lean/stretch Band 6, optional Band 7, and post-v1/parked Band 8. | During the unified GDD/v1 pass, use `plans/planned_unimplemented_feature_triage_2026-06-28.md` as the scheduling source. Keep the activity seam conditional, not a default v1 promise; keep the public scripting VM parked. |
