...
| [`campaign_data_ownership_research_handoff_2026-07-23.md`](campaign_data_ownership_research_handoff_2026-07-23.md) | `B3-CAMPAIGN-RULES`, `PP-FACTION-GOLD-ECONOMY`, `PP-STRATEGIC-DATA-OWNERSHIP` (tracker rows `RESEARCH-ECONOMY-OWNERSHIP`/`-PACK-SAVE-OWNERSHIP`/`-ENGINE-ZERO-CONTENT`/`-RULE-PROFILE-CONTRACT`) | Cross-track research handoff for the campaign rules/data-ownership/economy cluster; retire after the owner answers the findings questions and the features gain implementation-plan rows. |
...
| [`campaign_data_ownership_implementation_planning_handoff_2026-07-23.md`](campaign_data_ownership_implementation_planning_handoff_2026-07-23.md) | `PLAN-CAMPAIGN-DATA-OWNERSHIP-2026-07-23` feeding `B3-CAMPAIGN-RULES`, `PP-FACTION-GOLD-ECONOMY`, and `PP-STRATEGIC-DATA-OWNERSHIP` | Next-session planning-only handoff for the five approved implementation plans; retire after all plans and their tracker dependency graph land. |
| [`campaign_library_ux_research_handoff_2026-07-23.md`](campaign_library_ux_research_handoff_2026-07-23.md) | `DISCUSS-CAMPAIGN-LIBRARY-UX-2026-07-23` feeding `IMPL-ZERO-CONTENT-FOUNDATION` and the `IMPL-PACK-SAVE-*` slices | Next-session comparative-research, tool-evaluation, interaction-audit, wireflow, and intensive owner-question handoff for the campaign library; retire after approved decisions are absorbed into implementation sources. |
| [`ui_ux_research_goal_handoff_2026-07-24.md`](ui_ux_research_goal_handoff_2026-07-24.md) | `PLAN-UIUX-REUSE-PASS-2026-07-24` feeding `UI-INSPECTION` and the player-facing discussion queue | Research-only goal and evidence contract for the shared UI/UX vocabulary and owner-question pass; retire after the research deliverables land and become the row's direct sources. |
...
| [`zero_content_blockers_autonomous_execution_handoff_2026-07-23.md`](zero_content_blockers_autonomous_execution_handoff_2026-07-23.md) | `PLAN-ZERO-CONTENT-BLOCKER-HANDOFF-2026-07-23`, `B4-RESULT-ACTIONS-2026-07-22`, `PP-INTEGRATION-RELEASE-RECONCILE` | Autonomous execution order and conflict policy for the two zero-content prerequisites. |
| [`zero_content_blockers_owner_questions_2026-07-23.md`](zero_content_blockers_owner_questions_2026-07-23.md) | `DECISION-ZERO-CONTENT-BLOCKER-GATES-2026-07-23` | Triggered-only next-session owner question packet; remove after acceptance/deletion gates close. |
...
| [`text_entry_naming_and_sanitization_2026-07-26.md`](../design/text_entry_naming_and_sanitization_2026-07-26.md) | `RESEARCH-TEXT-ENTRY-STRATEGY-2026-07-26` | Companion packet: unit/weapon naming comparators, Godot 4.6.3-measured filename and BBCode limits, and the TEXT-09..12 validation-contract questions; retire with its parent packet. |
| [`text_entry_layout_implementation_research_2026-07-26.md`](../design/text_entry_layout_implementation_research_2026-07-26.md) | `RESEARCH-TEXT-ENTRY-STRATEGY-2026-07-26` | Companion packet: daisywheel/12-key/grid layout evidence, the corrected action-cost model, implementation references, and the TEXT-13..15 questions; retire with its parent packet. |
