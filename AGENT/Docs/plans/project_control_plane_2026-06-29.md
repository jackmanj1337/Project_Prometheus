...
| Track ID | Band | Status | Work item | Scope | Blocks / depends on | GDD owner | Decision source | Build source | Save / registry impact | Test / validation | Next action |
|---|---|---|---|---|---|---|---|---|---|---|---|
| `B3-CAMPAIGN-RULES` | 3 | Planned | CampaignRules profiles and tunables | Existing-field pack profiles are the narrow first slice; later adjustable locked/start/mid-run vocabulary remains here. | `B1-CST`, `B2-REGISTRY` | `GDD_01`, `GDD_02` | [`campaign_data_ownership_research_findings_2026-07-23.md`](campaign_data_ownership_research_findings_2026-07-23.md) | [`rule_profiles_implementation_plan_2026-07-23.md`](rule_profiles_implementation_plan_2026-07-23.md) | Save: selected profile plus resolved defaults; Registry: pack rule profiles | Resolution/update/save/migration fixtures | Narrow profile slice planned; broader tunables follow it. |
| `B3-COMBAT-ROLL-RESOLVER` | 3 | Target design | Author-selectable formula registries | Promote shipped hit/range/cost/requirement defaults through separate allow-listed registries; damage/growth/AI remain later extensions. | `B2-REGISTRY`, `B3-CAMPAIGN-RULES`, `B1-PKGA` | `GDD_01`, `GDD_02`, `GDD_04`, `GDD_08` | [`campaign_data_ownership_research_findings_2026-07-23.md`](campaign_data_ownership_research_findings_2026-07-23.md) | [`formula_registries_implementation_plan_2026-07-23.md`](formula_registries_implementation_plan_2026-07-23.md) | Save: stable formula ids/parameters; Registry: separate formula families | Determinism, malformed parameters, preview/runtime parity | No expression VM or pack code. |
...
| `B3-REQ` | 3 | Target design | Requirement / predicate system | Shared predicates and formula terms for dialogue, events, shops, objectives, perception, AI terms, and predicate-driven combat operations. | `B3-TCV`, `B2-REGISTRY` | `GDD_01`, `GDD_04`, `GDD_06`, `GDD_08` | [`requirement_predicate_system_open_questions_2026-06-25.md`](../registers/requirement_predicate_system_open_questions_2026-06-25.md) | [`band3_core_authoring_foundations_implementation_plan_2026-06-30.md`](band3_core_authoring_foundations_implementation_plan_2026-06-30.md), [`predicate_driven_combat_operations_implementation_plan_2026-07-28.md`](predicate_driven_combat_operations_implementation_plan_2026-07-28.md) | Registry: predicates/terms, combat operations/phases | Predicate truth-table and combat preview/execution parity tests | Build before gated authoring features. |
...
| `B3-PHB` | 3 | Planned | Prep-hub / option-panel framework | Shared prep and on-map panel surface for services and activations. | `B1-CST`, `B2-ACTION-EFFECT` | `GDD_07` | [`prep_hub_open_questions_2026-06-23.md`](../registers/prep_hub_open_questions_2026-06-23.md) | [`band3_core_authoring_foundations_implementation_plan_2026-06-30.md`](band3_core_authoring_foundations_implementation_plan_2026-06-30.md) | Save: service state only through owners; Registry: panel/activity types | Open activity registration/factory validation is green; node routing/input tests remain | Registry seam + inert fixture implemented 2026-07-19; node integration and concrete convoy/shop/training panels remain before the full track may be promoted. |
...
| `B3-RESOURCE-POOLS` | 3 | Target design | Resource pools and owner wallets | Multi-owner wallets for gold/bonus EXP/training points, atomic transactions, complete save/checkpoint/UI migration; later author resources build on the same registry. | `B1-F1`, `B2-RESOURCE-LEDGER`, pack-associated save migration | `GDD_01`, `GDD_04`, `GDD_05` | [`campaign_data_ownership_research_findings_2026-07-23.md`](campaign_data_ownership_research_findings_2026-07-23.md) | [`multi_owner_economy_implementation_plan_2026-07-23.md`](multi_owner_economy_implementation_plan_2026-07-23.md) | Save: complete wallets; Registry: resource types/owner kinds | Atomic/hotseat/save/rewind/projection fixtures | First playable slice removes all runtime scalar consumers. |
...
| `B3-REFERENCE-MODEL` | 3 | Planned | Generated reference model and More Info authority | Emit structured facts, relations, safe provenance, and separately formatted author notes from the activated pack and registered runtime rules; use them for More Info and headless GFM/PDF export, with HTML, native Compendium, and editor integration in later slices. | `B3-CAMPAIGN-RULES`, activated pack/registry identity; owning registries adopt the emitter contract incrementally | `GDD_01`, `GDD_02`, `GDD_03`, `GDD_04`, `GDD_05`, `GDD_06`, `GDD_07` | Owner planning discussion 2026-07-30 | [`generated_reference_model_implementation_plan_2026-07-30.md`](generated_reference_model_implementation_plan_2026-07-30.md) | Save: no_save_guard; Registry: every public handler validates and emits semantic facts/relations; export schema carries safe provenance | Deterministic semantic JSON, runtime/fact parity, provenance redaction, More Info parity, link validation, GFM/PDF golden fixtures | Build the schema/collector/headless JSON foundation after narrow rule profiles and before `B4-PXP`; PXP is the first complex emitter proof. |
...
| `B4-PXP` | 4 | Target design | Proficiency / XP framework | Weapon, item, source, action proficiency, effective-rank floors, independent trainability, proficiency/unit-EXP multipliers, and data-driven class-EXP award hooks without merging class leveling into PXP storage. | `B1-F1`, `B4-IEQ`, `B3-REFERENCE-MODEL` | `GDD_02`, `GDD_03`, `GDD_04` | [`proficiency_xp_framework_open_questions_2026-06-23.md`](../registers/proficiency_xp_framework_open_questions_2026-06-23.md), owner clarification 2026-07-30 | [`class_exp_pxp_boundary_plan_2026-06-29.md`](class_exp_pxp_boundary_plan_2026-06-29.md), [`generated_reference_model_implementation_plan_2026-07-30.md`](generated_reference_model_implementation_plan_2026-07-30.md) | Save: stored proficiency tracks; access floors/trainability/multipliers are source contributions; class EXP state remains existing unit fields; Registry: every effect emits facts/provenance | Award/profile/proficiency tests, floor/trainability overlap/removal, multiplier rounding and contribution provenance, plus class EXP regressions | Build stored PXP, access, effective floors, trainability, and multiplier channels as sibling contributions; prove the reference emitter contract in the same delivery. |
...
| `B5-SKILLS-EFFECTS` | 5 | Target design | Skill effect ids and grants | Required v1 skill effects, grants/revokes, loadout interactions, author-extensible effect ids, and generated trigger/condition/effect facts replacing generic skill prose. | `B2-REGISTRY`, `B2-ACTION-EFFECT`, `B5-CONDITIONS`, `B3-REFERENCE-MODEL` | `GDD_05` | [`skill_model_open_questions_2026-06-23.md`](../registers/skill_model_open_questions_2026-06-23.md), owner reference-model direction 2026-07-30 | [`band5_conditions_skills_implementation_plan_2026-07-03.md`](band5_conditions_skills_implementation_plan_2026-07-03.md), [`generated_reference_model_implementation_plan_2026-07-30.md`](generated_reference_model_implementation_plan_2026-07-30.md) | Save: learned/equipped skills, counters; Registry: skill effects validate and emit semantic facts/relations/provenance | Skill behavior/fact parity, availability, provenance, grant/revoke, and generic-fallback removal tests | Split required v1 ids from optional content ids; migrate `SkillData.description` to compatibility author notes and remove generic More Info only after handler coverage passes. |
...
| `B5-AI-MIN-SCORER` | 5 | Planned | Minimum combat AI improvement | Slice A's ordered exchange projection is implemented without adoption. Slice B scores existing legal weapon attacks using projection terms and stable ties while preserving shipped behavior as a compatibility preset; Slice C widens the same registry-backed loop to joint tile/target/source search plus exposure. | Slice B: existing `AISpec` seam, `B2-REGISTRY`, `B2-PROJECTION`; track closure: remaining `B5-AI-COMPOSITION`, `B5-SOURCE-STYLE`, `B3-MET` | `GDD_08` | [`ai_valuation_engagement_open_questions_2026-06-27.md`](../registers/ai_valuation_engagement_open_questions_2026-06-27.md) | [`band5_ai_implementation_plan_2026-07-03.md`](band5_ai_implementation_plan_2026-07-03.md); [`b5_ai_min_scorer_slice3a_handoff_2026-07-16.md`](b5_ai_min_scorer_slice3a_handoff_2026-07-16.md); [`weapon_attack_scorer_preimplementation_decisions_2026-07-16.md`](weapon_attack_scorer_preimplementation_decisions_2026-07-16.md) | Save: no_save_guard | Slice A: `test_project_exchange.gd` purity/order/bounds/cache; Slice B/C: lethal/counter/exposure/stable-tie, compatibility, staff/style/AoE/capture parity | Slice A implemented 2026-07-19 with no AI consumer. Do not start Slice B/C until A merges. Leave advanced search/perception to Band 7. |
...
| Track ID | Band | Status | Work item | Scope | Blocks / depends on | GDD owner | Decision source | Build source | Save / registry impact | Test / validation | Next action |
|---|---|---|---|---|---|---|---|---|---|---|---|
| `B6-CAMPAIGN-SHARING` | 6 | Implemented | Campaign sharing/export/import and strategic content ownership | Existing archive/discovery/activation/transfer pipeline is implemented; planned continuation makes the engine content-free, expands every Tier-2 family, extracts the base pack, and binds saves/migrations/backups to pack identity. | `B1-CST`, `B2-DATAMANAGER-SEAMS` | `GDD_01`, `GDD_07` | [`campaign_data_ownership_research_findings_2026-07-23.md`](campaign_data_ownership_research_findings_2026-07-23.md) | [`b6_campaign_archive_pipeline_handoff_2026-07-15.md`](b6_campaign_archive_pipeline_handoff_2026-07-15.md), [`zero_content_engine_implementation_plan_2026-07-23.md`](zero_content_engine_implementation_plan_2026-07-23.md), [`zero_content_maps_encounters_handoff_2026-08-01.md`](zero_content_maps_encounters_handoff_2026-08-01.md), [`pack_associated_save_implementation_plan_2026-07-23.md`](pack_associated_save_implementation_plan_2026-07-23.md) | Save: package/schema/fingerprint identity; Registry: all pack families/migrations | Existing archive suites plus no-pack/export/family/migration/backup fixtures | Existing pipeline green; strategic continuation follows canonical coordination dependencies. |
...
| `B6-WEB-DEBUG` | 6 | Planned | Debug web playtest build | Private web playtest channel and emulator-style touch shell. | `VAL-V023-DISPLAY` | `GDD_07`, `GDD_00` | [`debug_web_playtest_plan_2026-06-20.md`](debug_web_playtest_plan_2026-06-20.md), [`mobile_web_viewport_and_virtual_controller_implementation_plan_2026-08-04.md`](mobile_web_viewport_and_virtual_controller_implementation_plan_2026-08-04.md) | [`mobile_web_viewport_and_virtual_controller_implementation_plan_2026-08-04.md`](mobile_web_viewport_and_virtual_controller_implementation_plan_2026-08-04.md), [`mobile_web_controller_remaining_slices_handoff_2026-08-05.md`](mobile_web_controller_remaining_slices_handoff_2026-08-05.md) | Save: settings layout combinations | Godot layout-model tests, Playwright browser matrix, manual iPhone/iPad/Android validation | Owner authorized viewport reshaping plus virtual-gamepad and labeled-action profiles on 2026-08-04; execute the linked slices without overlapping the active safe-area service claim. Slices 1-2 built 2026-08-05 on unmerged `agent/from-integration/mobile-controller-web-wiring`; slices 3-6 outstanding, build state and traps in the linked handoff. |
...
| `B8-PUBLIC-BUILDER` | 8 | Deferred | Public campaign builder / authoring GUI | GUI authoring after gameplay and package rules stabilize; consume the reference model for fact preview, author-note editing, cross-links, full provenance, validation, and guide export. | `B6-CAMPAIGN-SHARING`, `B2-DATAMANAGER-SEAMS`, `B3-REFERENCE-MODEL` | `GDD_07`, `GDD_00` | [`designer_authoring_contract_2026-06-28.md`](../design/designer_authoring_contract_2026-06-28.md), owner reference-model direction 2026-07-30 | [`generated_reference_model_implementation_plan_2026-07-30.md`](generated_reference_model_implementation_plan_2026-07-30.md) plus future editor UX plan | Save: external content ids; Registry: public content validation/reference coverage | Future authoring validation; editor remains a thin wrapper over headless extraction/export | Park GUI implementation for post-v1; include reference preview/export in the dedicated editor UX design without moving semantic logic into the editor. |
...
| `B8-FREE-TEXT-DIALOGUE` | 8 | Deferred | `free_text_dialogue` authored-choice intent provider | Optional local rules/embedding/classifier maps a participant's natural-language response only to an available authored choice ID; confidence, confirmation, manual fallback, privacy, deterministic result persistence, and constrained authority are mandatory. V1 builds only the abstract decision-provider seam and menu provider. | `B4-DIALOGUE-V1`; localization + intent fixtures; remote mode also `B8-REMOTE-PLAY` | `GDD_07` | [`dialogue_recruit_capture_research_questions_2026-07-27.md`](../registers/dialogue_recruit_capture_research_questions_2026-07-27.md) (`free_text_dialogue`) | needs future feasibility/implementation plan | Save: chosen option + resolver identity/version, raw text optional/private; Registry: decision providers/resolvers | Intent fixture regressions, confidence/fallback, skip/save/replay equivalence, unavailable-option rejection, prompt-injection authority boundary | Keep post-v1; never required for campaign completion. |
...
| `CLEAN-INT-RELEASE-RECONCILE` | Cleanup | Implemented | Reconcile `agent/integration` with the released line | Accepted v0.5.8 and the infrastructure-bearing `main` promotion are ancestors of `agent/integration`; the nine text conflicts were resolved without runtime gameplay conflicts. | Tracker row PP-INTEGRATION-RELEASE-RECONCILE | `GDD_10` | v0.5.8 owner acceptance 2026-07-29 | [`integration_release_reconcile_plan_2026-07-29.md`](integration_release_reconcile_plan_2026-07-29.md) | no_save_guard | Full suite, `check_docs.py`, `check_gdscript_style.sh` green on the merge | Closed at integration `6fa2a7ea`; do not repeat unless a later main promotion creates new divergence. |
| `CLEAN-INT-FEATURE-BRANCHES` | Cleanup | Implemented | Consolidate the outstanding feature branches onto current integration | Import/evidence/session-note gates are hardened; planning and research were semantically curated; BBCode and both schema prototypes landed only after their negative validation gaps closed. | `CLEAN-INT-RELEASE-RECONCILE`; tracker row MERGE-ORDER-FROM-INTEGRATION-2026-07-29 | `GDD_10` | [`integration_feature_branch_consolidation_closeout_2026-07-29.md`](../../Code Reviews/integration_feature_branch_consolidation_closeout_2026-07-29.md) | [`integration_feature_branch_consolidation_plan_2026-07-29.md`](integration_feature_branch_consolidation_plan_2026-07-29.md) | no_save_guard | 111 GDScript suites, executable schema fixtures, docs/claims/style, clean-cache import/full suite, final content inventory | Closed 2026-07-29; future features start from current `agent/integration`, not the archived source tips. |
...
|---|---|---|
| [`../design/roster_composition_comparative_research_2026-09-20.md`](../design/roster_composition_comparative_research_2026-09-20.md) | `ROUTE-GAP-ACCEPTANCE-CONTENT-2026-09-20`; the `ROS-1..6` rulings | Comparative research into Fire Emblem and Advance Wars roster models, written to settle how a pack author puts specific units on a specific chapter. It spans the campaign launch seam, the prep constraint set and the pack ruleset boundary, so it belongs to no single feature row; its decisions live in [`campaign_roster_composition_2026-09-20.md`](../registers/campaign_roster_composition_2026-09-20.md). Retire once `STANDALONE-MAP-RULESET-2026-09-20` and `ROSTER-JOIN-2026-09-20` both close. |
...
| 2A | `B3-REFERENCE-MODEL` | After the narrow CampaignRules profile slice, freeze semantic entry/fact/relation/provenance contracts and build deterministic headless JSON extraction from the activated catalogue. | Foundation only before `B4-PXP`: no compendium, HTML polish, or editor GUI; legacy prose must be labelled compatibility-authored rather than generated truth. |
