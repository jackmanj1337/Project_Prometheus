...
- [2026-06-19](2026-06-19.md) — Triaged the returned v0.2.0 playtest package into the live roadmap pipeline and wrote the plan-only fix handoff `playtest_v0.2.0_triage_plan_2026-06-19.md` (`5043dca`). Logged 6 immediate defects (zoom/camera cluster, F9 refresh, Seize coordinate display, terrain More Info reset), 8 polish/backlog items, and the pending UI-scale / CON-LoS / rerun decisions. No runtime code changed; targeted docs checks + `git diff --check` passed; full `check_docs.py` timed out at its feature-index scan.
