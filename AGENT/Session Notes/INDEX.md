...
- [2026-06-16b](2026-06-16b.md) — Code-reviewed the 2026-06-16 feedback slice and fixed 3 low-sev findings (`653a31f`: F9 cycle-guard refund + regression test, null-hotseat-controller comment, TILE_SIZE-derived `PU` badge). Then cut the **v0.1.7.0** combined playtest build: bumped version strings (release-metadata 5/5), wrote the combined handbook `playtest_checklist_v0.1.7.0.md` (supersedes the 3 focused checklists — character sheet + Display & Accessibility + 2026-06-16 features), exported `Project_Prometheus_v0.1.7.0_debug.exe` (SHA `f8e5015c…`) + manifest, tracked 7 orphaned `.uid` sidecars (`77d6dd8`, `fe707bd`). Suite/docs green; visual confirmation pending on real Windows.
