...
| AI behavior | Split (basic profiles + bounded attack scorer compatibility seam Implemented / tactical adoption + parity Target) | GDD_08 §Implemented Profiles, §Weapon-Attack Scoring Track, §AI Determinism & Parity | GDD_01 §EnemyAI / §Determinism | GDD_10 §M14 stages 4–5 (COMPLETE); Phase 3 Backlog (tactical adoption, additional profiles) | `EnemyAI.gd`, `WeaponAttackScorer.gd`, `GridManager.gd` (`dijkstra_costs`) | `test_enemy_ai.gd`, `test_weapon_attack_scorer.gd` | TBD (S3) | RNG-4, OPEN-4 | `awakening_core_systems.md` |
