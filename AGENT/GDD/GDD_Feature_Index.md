...
| Registry manifest and open registries | Target design | `GDD_01` | `B2-REGISTRY`, `B3-MOVEMENT-VULN-REGISTRY`, `B3-STAT-REGISTRY`, `B3-RESOURCE-POOLS`, `B5-AI-COMPOSITION` | `authoring_extensibility_open_questions_2026-06-26.md`, `registry_manifest_contract_2026-06-28.md` | target: registry validation tests |
