...
|---|---|---|---|---|---|---|---|---|---|
| Combat calculations & RNG | Mixed (project Implemented / corpus Target) | GDD_02 §Combat | GDD_01 §CombatResolver | TBD (S4) | TBD (S3) | TBD (S3) | TBD (S3) | SET-001, RULE-001, RNG-1…4, pipeline order, OPEN-3/6/7 | `awakening_lookup_tables.md`, `awakening_core_systems.md` |
| Weapon triangle & rank bonuses | Target design | GDD_04 §Weapon triangle | GDD_02 §Modifier pipeline | TBD (S4) | TBD (S3) | TBD (S3) | TBD (S3) | SET-003, SET-005, RULE-002, RULE-013 | `awakening_weapons_physical.md`, `awakening_weapons_magic.md` |
| WEXP & equipment legality | Target design | GDD_04 §WEXP | GDD_01 §Item/weapon data | TBD (S4) | TBD (S3) | TBD (S3) | TBD (S3) | SET-004, RULE-003, RULE-004 | `awakening_lookup_tables.md` |
| EXP, leveling, promotion & reclass | Mixed | GDD_03 §Progression | GDD_01 §Unit data | AWR (TBD) | TBD (S3) | TBD (S3) | TBD (S3) | SET-006, SET-007, RULE-005, RULE-006, D-E, RULE-008 | `awakening_core_systems.md`, `awakening_archetypes.md` |
| Classes & class skills | Target design | GDD_03 §Classes / GDD_05 §Class skills | GDD_01 §ClassData | AWR-2 | TBD (S3) | TBD (S3) | TBD (S3) | SET-009, RULE-007, RULE-008, RULE-009, OPEN-9, OPEN-10 | `awakening_classes_base.md`, `awakening_classes_promoted.md`, `awakening_classes_special.md` |
...
| Faction scheduling & controllers | Implemented | GDD_02 §Turn/faction (TBD) | GDD_01 §TurnManager | — | TBD (S3) | TBD (S3) | TBD (S3) | OPEN-6 | — |
| Status conditions | Mixed | GDD_02 §Conditions (TBD) | — | TBD (S4) | TBD (S3) | TBD (S3) | TBD (S3) | OPEN-2 | `awakening_skills.md` (interactions) |
| Skills | Mixed | GDD_05 §Skills | GDD_01 §SkillHandler | TBD (S4) | TBD (S3) | TBD (S3) | TBD (S3) | OPEN-2, RULE-009 | `awakening_skills.md` |
| Inventory, trade, convoy, shops & economy | Mixed (shops/recruit Planned) | GDD_04 §Items/economy | GDD_01 §Inventory | TBD (S4) — D-D edge | TBD (S3) | TBD (S3) | TBD (S3) | D-D, OPEN-5 | `awakening_items.md` |
| Save, retry, suspend & rewind | Target design | GDD_01 §Snapshot contract | GDD_01 §Snapshot contract | TBD (S4) | RNG contract §8 | TBD (S3) | TBD (S3) | RNG-2, RNG-3, OPEN-13 | — |
