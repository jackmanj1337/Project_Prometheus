...
> **Effectiveness:** A weapon effective against a unit treats its Mt as **3× higher** when fighting that unit.  
...
| Bolt Axe | B | 13 | 65 | 0 | 1–2 | 12 | 25 | 4,750 | MAG not STR; Thunder for magic weapon triangle | 2 |
| Brave Axe | B | 11 | 60 | 0 | 1 | 14 | 30 | 4,600 | 2× Strikes | 2 |
...
| Brave Bow | B | 10 | 70 | 0 | 2 | 12 | 30 | 5,850 | Flying, 2× Strikes | 2 |
| Bright Bow | B | 10 | 70 | 0 | 2 | 9 | 25 | 5,750 | Flying; MAG not STR; Light for magic weapon triangle | 2 |
| Double Bow | A | 9 | 65 | 5 | 1–2 | 10 | 30 | 5,400 | Flying | 2 |
| Silver Bow | A | 13 | 80 | 0 | 2 | 13 | 25 | 2,000 | Flying | 3 |
| Silver Longbow | A | 15 | 65 | 0 | 2–3 | 15 | 20 | 5,000 | Flying | 4 |
...
| Brave Lance | B | 10 | 70 | 0 | 1 | 17 | 30 | 5,700 | 2× Strikes | 2 |
| Flame Lance | B | 10 | 75 | 0 | 1–2 | 12 | 25 | 7,500 | Beast; MAG not STR; Fire for magic weapon triangle | 2 |
...
| Brave Sword | B | 9 | 70 | 0 | 1 | 16 | 30 | 5,400 | 2× Strikes | 2 |
| Sonic Sword | B | 10 | 75 | 0 | 1–2 | 9 | 25 | 5,500 | Flying; MAG not STR; Wind for magic weapon triangle | 2 |
| Runesword | A | 12 | 70 | 0 | 1–2 | 19 | 15 | 7,200 | MAG not STR; Gain HP equal to damage; Dark for magic weapon triangle | 3 |
...
| Brave Dagger | B | 7 | 75 | 0 | 1 | 6 | 30 | 6,500 | 2× Strikes | 2 |
...
> Staves **cannot be forged**. They lose durability even on a miss. Range for healing/utility staves: 1–MAG/2 unless stated.
...
| Berserk | B | 60 + MAG − target's RES | Target is Berserk | 1–MAG/2 | 8 | 3 | 1,500 | 3 |
| Recover | B | — | Heals all HP | 1 | 6 | 15 | 2,250 | 2 |
| Silence | B | 70 + MAG − target's RES | Target is Silenced | 1–MAG/2 | 5 | 3 | 1,200 | 2 |
...
| Sleep | A | 65 + MAG − target's RES | Target is Asleep | 1–MAG/2 | 5 | 3 | 1,200 | 3 |
...
| Forblaze | S | 15 | 80 | 10 | 1 and 2 (both spaces, straight line) | 12 | 30 | 10,000 | Beast | 5 |
...
Laguz weapons have no cost, weight, or uses — they are innate to the unit's animal form.

| Name | Rank | Mt | Hit | Crit | Range | Effect | wEXP |
|------|------|----|-----|------|-------|--------|------|
| Beak | E | 2 | 80 | 5 | 1 | — | 1 |
| Claw | E | 4 | 65 | 0 | 1 | — | 1 |
| Fang | E | 3 | 75 | 0 | 1 | — | 1 |
...
### Stationary Battlefield Weapons

Usable by any **non-mounted** unit with **any rank** of Bow proficiency.

| Name | Mt | Hit | Crit | Range | Wt | Uses | Effect | wEXP |
|------|----|-----|------|-------|----|------|--------|------|
...
| Onager | 20 | Always hits | Cannot | 3–10 | 30 | 5 | Damages target space and all adjacent units; Ignores user's STR | 4 |

---

## Forging

Weapons can be modified at purchase if a forge is available (GM discretion). Staves cannot be forged.

| Stat | Increment | Max Change |
|------|-----------|------------|
| Mt | ±1 per increment | ±5 |
| Hit | ±5 per increment | ±25 |
| Crit | ±3 per increment | ±15 |
| Wt | ±1 per increment | ±5 |

**Total modifications per weapon: 20** (5 per stat × 4 stats)

| Increment | Cost | Cumulative Total |
|-----------|------|-----------------|
| 1st | 150 gold | 150 gold |
| 2nd | 300 gold | 450 gold |
| 3rd | 450 gold | 900 gold |
| 4th | 600 gold | 1,500 gold |
| 5th | 750 gold | 2,250 gold |

Maxing all 4 stats costs **9,000 gold** (in addition to the weapon's base cost).
...
> Only **1 equip item** may be equipped at any given time.

| Name | Effect | Cost |
|------|--------|------|
| Full Guard | Negates bonus damage against this unit | 8,500 |
| Wing Guard | Negates bonus damage from Flying effectiveness | 6,000 |
| Laguz Guard | Negates bonus damage from Laguz effectiveness | 6,000 |
| Iron Rune | Negates any critical hits against this unit | 6,500 |
| Knight Ring | Unit can move remaining movement after actions, as though it had Mounted or Flying qualities | 8,500 |
| Knight Ward | +2 DEF and RES, +30% SPD growth rate. Cavalier, Knight, and Soldier lines only | 6,500 |

---

### Stat Items

All stat items are permanent, single-use, and cost **8,000 gold** each.

| Name | Effect |
|------|--------|
| Arms Scroll | Increases 1 proficiency to the next rank |
| Boots | Permanent +2 Movement |
| Dracoshield | Permanent +2 DEF |
| Energy Drop | Permanent +2 STR |
| Goddess Icon | Permanent +2 LUK |
| Secret Book | Permanent +2 SKL |
| Seraph Robe | Permanent +7 Max HP |
| Speedwing | Permanent +2 SPD |
| Spirit Dust | Permanent +2 MAG |
| Statue Frag | Permanent +2 CON |
| Talisman | Permanent +2 RES |
...
| Coin | Can be sold for 1 gold, or used during forging for 1 random stat increment (user chooses + or −) | 2 |
...
| Name | Effect | Uses | Cost |
|------|--------|------|------|
| Master Seal | Promotes any Beorc unit early, or grants a Laguz their Laguz skill + ability to receive occult skill early | 1 | 20,000 |
| Orion's Bolt | Promotes an Archer or Nomad early | 1 | 10,000 |
| Fell Contract | Promotes a Thief early | 1 | 10,000 |
| Knight Crest | Promotes a Cavalier, Knight, or Soldier early | 1 | 10,000 |
| Guiding Ring | Promotes a Bard, Cleric, Druid, or Mage early | 1 | 10,000 |
| Hero Crest | Promotes a Brigand, Fighter, Mercenary, or Myrmidon early | 1 | 10,000 |
| Elysian Whip | Promotes a Pegasus Knight or Wyvern Rider early | 1 | 10,000 |
| Laguz Seal | Grants a Laguz their Laguz skill and ability to receive occult skill early | 1 | 10,000 |
| Occult Scroll | Grants a promoted unit their occult skill | 1 | 15,000 |
