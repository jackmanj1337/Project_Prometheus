...
|---|---|---|---|---|---|---|
| Combat-stat formulas (Atk/Hit/Avo/Crit/AS) | `awakening_core_systems`, `awakening_lookup_tables` | Adopted target | GDD_02 §Unit Stats & Derived Combat Values | — | Target design | SET-001 |
...
| Internal level (`20 + displayed`) | `awakening_project_index` | Adopted target | GDD_03 §Progression Counters | — | Target design | SET-006 |
...
| Light/Dark magic class lines | (project addition; not in corpus) | Adopted project variation | GDD_03 §Starter Roster & Classes (Known gaps) + GDD_05 §Skill Acquisition | Tome families and track-coverage guard implemented; magic-triangle wiring remains separate. | Split | RULE-009 |
...
| Cleric "Light E" access | `awakening_classes_*` | Rejected | GDD_05 §Skill Acquisition (→ GDD_03) | Staff-only base; Light arrives on promotion to Bishop | Implemented | OPEN-10 (RULE-009) |
