...
| 4 | `B6-MRD` | Finish MRD-7 shared-cell visual prototype | MRD-7 compose plumbing landed 2026-07-09: selection/targeting overlays now compose with retained threat/watch specs and keep "D" markers. Remaining: prototype both shared-cell treatments (border-through and second-layer stacking) behind a toggle, compare headless screenshots, then let the focused live rerun pick the presentation. |
