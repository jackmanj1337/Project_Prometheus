...
reference validation. Package-backed campaign and suspend resume both wrap activation
in an outer rollback transaction: late campaign-reference rejection restores the prior
content session, registry catalogue, campaign position, mutable rules, convoy, and
roster together. New Game now appends validated installed campaigns with
